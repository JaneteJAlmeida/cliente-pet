...
public class RestResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handlerGenericException(APIException ex){
        return ex.buildErrorResponseEntity();
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<ErrorApiResponse> handlerGenricException(Exception ex) {
        log.error("Exception: ", ex);
        ErrorApiResponse error = ErrorApiResponse.builder()
